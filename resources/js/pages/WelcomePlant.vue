...
<template>
    <AppLayout title="FloraFinder">
        ...
        <section aria-labelledby="hero-heading" class="relative overflow-hidden">
            ...
            ></div>
            <div class="from-sage-100/90 to-moss-100/90 dark:from-sage-900/90 dark:to-moss-950/90 absolute inset-0 bg-gradient-to-br"></div>
            <div class="relative z-10 mx-auto max-w-7xl px-6 py-24 sm:py-32 md:flex md:items-center md:justify-between md:gap-x-8 lg:px-8">
                <div class="max-w-xl md:flex-1 md:py-12">
                    <h1 id="hero-heading" class="text-moss-900 text-4xl font-extrabold tracking-tight dark:text-white sm:text-5xl">
                        <span class="block">Discover &amp; Identify</span>
                        <span class="text-sage-600 dark:text-sage-400 block">Malaysian Plants</span>
                    </h1>
                    <p class="text-sage-700 dark:text-sage-300 mt-6 text-lg font-semibold leading-8">
                    ...
                    <div class="mt-10 flex flex-col gap-4 sm:flex-row">
                        <Link href="/plant-identifier" class="group" aria-label="Identify plants with your camera">
                            <Button
                                class="from-moss-600 to-sage-600 hover:from-moss-700 hover:to-sage-700 dark:from-moss-800 dark:to-sage-800 dark:hover:from-moss-700 dark:hover:to-sage-700 w-full rounded-xl bg-gradient-to-r text-white shadow-lg transition-all duration-200 dark:text-white"
                            >
                        ...
                        <Link href="/plant-search" class="group" aria-label="Browse the plant database">
                            <Button
                                variant="outline"
                                class="border-moss-300 dark:border-moss-700 hover:bg-moss-50 dark:hover:bg-moss-900/30 w-full rounded-xl"
                            >
                                <div class="flex items-center justify-center gap-2">
                ...
                <div class="mt-12 flex-1 md:mt-0">
                    <Card
                        class="dark:bg-moss-900/60 overflow-hidden rounded-3xl border-0 bg-white/70 shadow-xl ring-1 ring-gray-200 backdrop-blur-md dark:ring-gray-800"
                    >
        ...
        <section aria-labelledby="potd-heading" class="bg-white px-4 py-16 dark:bg-gray-950 sm:px-6 lg:px-8">
            <div class="mx-auto max-w-5xl">
                <div class="mb-12 text-center">
                    <h2 id="potd-heading" class="text-moss-900 dark:text-moss-100 text-2xl font-bold tracking-tight sm:text-3xl">Plant of the Day</h2>
                    <p class="text-sage-600 dark:text-sage-400 mt-3">Explore a new Malaysian plant each day</p>
                </div>

                <Card
                    class="dark:bg-sage-900/60 overflow-hidden rounded-3xl border-0 bg-white/80 shadow-xl ring-1 ring-gray-200 backdrop-blur-md dark:ring-gray-800"
                >
                    <div class="grid grid-cols-1 md:grid-cols-12">
                        ...
                        <div class="flex flex-col justify-center p-6 md:col-span-7 md:p-8">
                            <h3 class="text-sage-900 text-2xl font-bold dark:text-white">
                                {{ plantOfTheDay.commonName }}
                            </h3>
                            <p class="text-sage-500 dark:text-sage-400 mb-4 mt-1 text-sm italic">
                                {{ plantOfTheDay.name }}
                            </p>
                            ...
                            <div class="mt-6">
                                <Link href="/plants/mangosteen">
                                    <Button variant="outline" class="hover:bg-sage-50 dark:hover:bg-sage-900/30 rounded-full shadow-sm">
        ...
        <section aria-labelledby="features-heading" class="relative overflow-hidden px-4 py-16 sm:px-6 lg:px-8">
            ...
            ></div>
            <div class="from-sage-50/90 dark:from-sage-950/90 absolute inset-0 bg-gradient-to-b to-white/90 dark:to-gray-950/90"></div>
            <div class="relative z-10 mx-auto max-w-5xl">
                <div class="mb-12 text-center">
                    <h2 id="features-heading" class="text-moss-900 dark:text-moss-100 text-2xl font-bold tracking-tight sm:text-3xl">Key Features</h2>
                    <p class="text-sage-600 dark:text-sage-400 mt-3">Everything you need to explore Malaysian flora</p>
                </div>
                ...
                <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
                    <div
                        ...
                        :key="feature.title"
                        class="dark:bg-sage-900/40 overflow-hidden rounded-2xl border-0 bg-white/70 p-6 shadow-lg ring-1 ring-gray-200 backdrop-blur-md transition-shadow hover:shadow-xl dark:ring-gray-800"
                    >
                        <div class="flex flex-col items-center text-center">
                            <div class="bg-moss-100 dark:bg-moss-900/60 mb-4 flex items-center justify-center rounded-full p-3 shadow-inner">
                            ...
                            <h3 class="text-moss-900 mb-2 text-lg font-semibold dark:text-white">
                                {{ feature.title }}
                            </h3>
        ...
        <section aria-labelledby="popular-heading" class="bg-white px-4 py-16 dark:bg-gray-950 sm:px-6 lg:px-8">
            <div class="mx-auto max-w-5xl">
                <div class="mb-12 text-center">
                    <h2 id="popular-heading" class="text-moss-900 dark:text-moss-100 text-2xl font-bold tracking-tight sm:text-3xl">
                        Popular Malaysian Plants
                    </h2>
                    <p class="text-sage-600 dark:text-sage-400 mt-3">Discover some of Malaysia's most iconic flora</p>
                </div>
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    >
                        ...
                        <div class="bg-white p-4 dark:bg-gray-900">
                            <h4 class="text-moss-900 font-semibold dark:text-white">
                                {{ plant.name }}
                            </h4>
        ...
        <section aria-labelledby="cta-heading" class="relative overflow-hidden px-4 py-16 sm:px-6 lg:px-8">
            ...
            ></div>
            <div class="from-moss-600/90 to-sage-600/90 dark:from-moss-900/90 dark:to-sage-900/90 absolute inset-0 bg-gradient-to-r"></div>
            <div class="relative z-10 mx-auto max-w-5xl text-center">
                ...
                <p class="mt-3 text-lg text-white/80">Start identifying plants in your surroundings today.</p>
                <div class="mt-8">
                    <Link href="/plant-identifier" aria-label="Start identifying plants now">
                        <Button class="text-moss-800 rounded-full bg-white shadow-lg hover:bg-white/90">
                            <div class="flex items-center gap-2">
                                <Icon name="camera" class="h-4 w-4" />
