...
<template>
  <AppLayout title="FloraFinder">
    ...
    <section aria-labelledby="hero-heading" class="relative overflow-hidden">
      ...
      ></div>
      <div
        class="from-sage-100/90 to-moss-100/90 dark:from-sage-900/90 dark:to-moss-950/90 absolute inset-0 bg-gradient-to-br"
      ></div>
      <div
      ...
      >
        <div class="max-w-xl md:flex-1 md:py-12">
          <h1
            id="hero-heading"
            class="text-moss-900 text-4xl font-extrabold tracking-tight dark:text-white sm:text-5xl"
          >
            <span class="block">Discover &amp; Identify</span>
            <span class="text-sage-600 dark:text-sage-400 block">Malaysian Plants</span>
          </h1>
          <p
            class="text-sage-700 dark:text-sage-300 mt-6 text-lg font-semibold leading-8"
          >
    ...
    >
      <div class="mx-auto max-w-5xl">
        <div class="mb-12 text-center">
          <h2
            id="potd-heading"
            class="text-moss-900 dark:text-moss-100 text-2xl font-bold tracking-tight sm:text-3xl"
          >
            Plant of the Day
          </h2>
          <p class="text-sage-600 dark:text-sage-400 mt-3">
            ...
            <div class="flex flex-col justify-center p-6 md:col-span-7 md:p-8">
              ...
              <div class="mt-6">
                <Link href="/plants/mangosteen">
                  <Button
                    variant="outline"
                    class="hover:bg-sage-50 dark:hover:bg-sage-900/30 rounded-full shadow-sm"
                  >
    ...
    >
      ...
      ></div>
      <div
        class="from-sage-50/90 dark:from-sage-950/90 absolute inset-0 bg-gradient-to-b to-white/90 dark:to-gray-950/90"
      ></div>
        ...
        <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          >
            <div class="flex flex-col items-center text-center">
              <div
                class="bg-moss-100 dark:bg-moss-900/60 mb-4 flex items-center justify-center rounded-full p-3 shadow-inner"
              >
    ...
    >
      ...
      ></div>
      <div
        class="from-moss-600/90 to-sage-600/90 dark:from-moss-900/90 dark:to-sage-900/90 absolute inset-0 bg-gradient-to-r"
      ></div>
      <div class="relative z-10 mx-auto max-w-5xl text-center">
        ...
        <div class="mt-8">
          <Link href="/plant-identifier" aria-label="Start identifying plants now">
            <Button
              class="text-moss-800 rounded-full bg-white shadow-lg hover:bg-white/90"
            >
              <div class="flex items-center gap-2">
                <Icon name="camera" class="h-4 w-4" />
