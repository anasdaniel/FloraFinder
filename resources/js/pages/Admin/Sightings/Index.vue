        ...
        <div class="p-6 space-y-6">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-muted-foreground">Review and manage plant sightings reported by users.</p>
                </div>
            </div>
                            ...
                            <TableRow v-for="sighting in sightings.data" :key="sighting.id">
                                <TableCell>
                                    <img
                                        ...
                                        alt="Sighting"
                                    />
                                    <div v-else class="h-12 w-12 bg-muted rounded-md flex items-center justify-center">
                                        <Leaf class="h-6 w-6 text-muted-foreground" />
                                    </div>
                                </TableCell>
                                <TableCell>
                                    <div class="font-medium">{{ sighting.common_name || 'Unknown' }}</div>
                                    <div class="text-xs text-muted-foreground italic">{{ sighting.scientific_name }}</div>
                                </TableCell>
                                <TableCell>
                                ...
                                <TableCell class="text-right">
                                    <div class="flex justify-end gap-2">
                                        ...
                                        <Button variant="destructive" size="icon" @click="deleteSighting(sighting.id)">
